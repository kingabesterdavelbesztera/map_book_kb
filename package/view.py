...
ramka_lista_obiekow.grid(row=0, column=0, padx=50)
...
listbox_lista_obiektow = Listbox(ramka_lista_obiekow, width=50)
button_pokaz_szczegoly = Button(ramka_lista_obiekow, text="Pokaż szczegóły", command=pokaz_szczegoly_uzytkownika)
button_usun_obiekt = Button(ramka_lista_obiekow, text="Usuń obiekt", command=usun_uzytkownika)
button_edytuj_obiekt = Button(ramka_lista_obiekow, text="Edytuj obiekt", command=edytuj_uzytkownika)
